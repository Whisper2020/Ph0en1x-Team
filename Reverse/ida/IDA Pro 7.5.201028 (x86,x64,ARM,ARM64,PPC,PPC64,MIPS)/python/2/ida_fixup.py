...
class fixup_data_t(object):
    ...
    __repr__ = _swig_repr
    sel = property(_ida_fixup.fixup_data_t_sel_get, _ida_fixup.fixup_data_t_sel_set)
    off = property(_ida_fixup.fixup_data_t_off_get, _ida_fixup.fixup_data_t_off_set)
    displacement = property(_ida_fixup.fixup_data_t_displacement_get, _ida_fixup.fixup_data_t_displacement_set)
...
class fixup_info_t(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ea = property(_ida_fixup.fixup_info_t_ea_get, _ida_fixup.fixup_info_t_ea_set)
    fd = property(_ida_fixup.fixup_info_t_fd_get, _ida_fixup.fixup_info_t_fd_set)
