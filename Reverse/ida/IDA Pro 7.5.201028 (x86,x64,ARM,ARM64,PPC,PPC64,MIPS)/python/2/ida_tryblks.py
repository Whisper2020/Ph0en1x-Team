...
class try_handler_t(ida_range.rangevec_t):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    disp = property(_ida_tryblks.try_handler_t_disp_get, _ida_tryblks.try_handler_t_disp_set)
    fpreg = property(_ida_tryblks.try_handler_t_fpreg_get, _ida_tryblks.try_handler_t_fpreg_set)
...
class seh_t(try_handler_t):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    filter = property(_ida_tryblks.seh_t_filter_get, _ida_tryblks.seh_t_filter_set)
    seh_code = property(_ida_tryblks.seh_t_seh_code_get, _ida_tryblks.seh_t_seh_code_set)
...
class catch_t(try_handler_t):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    obj = property(_ida_tryblks.catch_t_obj_get, _ida_tryblks.catch_t_obj_set)
    type_id = property(_ida_tryblks.catch_t_type_id_get, _ida_tryblks.catch_t_type_id_set)
...
class tryblk_t(ida_range.rangevec_t):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    level = property(_ida_tryblks.tryblk_t_level_get, _ida_tryblks.tryblk_t_level_set)
