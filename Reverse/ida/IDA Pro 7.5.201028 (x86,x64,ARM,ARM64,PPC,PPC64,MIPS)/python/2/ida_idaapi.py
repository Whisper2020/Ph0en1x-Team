...
class loader_input_t(object):
    ...
    __repr__ = _swig_repr
    __idc_cvt_id__ = property(_ida_idaapi.loader_input_t___idc_cvt_id___get, _ida_idaapi.loader_input_t___idc_cvt_id___set)
...
def loader_input_t_from_capsule(*args):
    r"""
