...
//              %appdata%/Hex-Rays/IDA Pro/userida.idc  (Windows)
//              $HOME/.idapro/userida.idc               (Linux & Mac)
...
static main(void)
{
  ...
  // userida.idc should define user_main(), call it here.
  auto e;
  try
  {
    user_main();
  ...
  {
    // if userida.idc did not exist, silently ignore the call error.
